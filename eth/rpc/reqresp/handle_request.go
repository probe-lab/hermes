...
func (handle RequestPayloadHandler) MakeStreamHandler(ctx context.Context, comp Compression, minreqrespContentSize, maxreqrespContentSize uint64, timeout time.Duration) network.StreamHandler {
